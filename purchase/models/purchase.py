...
# usman add product id in master
    ...
    # move product_id from po master to account master
...
class PurchaseOrderLine(models.Model):
    ...
    price_subtotal = fields.Monetary(compute='_compute_amounted', string='Subtotal', store=True)
    carton = fields.Integer("Cartons")
    labour = fields.Integer("Labour")
    carton_rate = fields.Integer("Carton Rate")
    mon = fields.Integer(string="Mon", default=40)
    ...
    carton_value = fields.Integer("Carton Value", compute="_compute_carton")
    ...
    # code for calculate price subtotal by usman
    ...
    def _prepare_compute_all_values(self):
        ...
        # compute formula for labour_rate
    ...
    # move fields to invoice lines edited by usman
